        ...
        <footer className="border-t border-card-border bg-card-bg/20 backdrop-blur-md py-16 px-6 md:px-12 lg:px-24">
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center md:items-start gap-8 text-xs font-mono text-foreground/50 w-full">
            <div className="flex flex-col gap-2 items-center md:items-start text-center md:text-left">
              <span className="font-bold text-foreground text-sm">김준하 &copy; 2026</span>
            </div>

            {/* 실제 연락처 정보 통합 */}
            <div className="flex flex-col gap-3 text-xs">
              <a href="mailto:rlawnsgk0610@gmail.com" className="flex items-center gap-2 hover:text-accent-blue transition-colors">
                <Mail className="w-4 h-4" />
                <span>rlawnsgk0610@gmail.com</span>
              </a>
              <span className="flex items-center gap-2">
                <Phone className="w-4 h-4" />
                <span>010-9383-9023</span>
              </span>
              <a href="https://github.com/kimjunha1231" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-accent-blue transition-colors">
                ...
                <span>github.com/kimjunha1231</span>
              </a>
            </div>
          </div>
        </footer>
